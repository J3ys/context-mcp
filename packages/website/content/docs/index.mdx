...
Want an end-user chat UI on top of your docs? Pair ContextMCP with [ContextChat](https://github.com/contextmcp/context-chat) — a drop-in, embeddable "Ask AI" widget that streams cited answers from your `/search` endpoint.
