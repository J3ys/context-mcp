...
<script src="https://your-contextchat-worker.workers.dev/widget.js" defer></script>
```

See the [ContextChat README](https://github.com/contextmcp/context-chat) for full setup and configuration.
